...
- Search entry `href` changed from absolute console URL to relative
...
@@ -20,7 +20,7 @@
-          href: https://console.redhat.com/openshift/assisted-installer/clusters/~new
+          href: /openshift/assisted-installer/clusters/~new
```
...
- Auth interceptor URL building replaced with `resolveRequestUrl` (handles absolute URLs, trailing
  slashes)
...
24. `assisted-installer-app/src/typings.d.ts`
