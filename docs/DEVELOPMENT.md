...
Assisted Installer runs in the Hybrid Cloud Console through
[`assisted-installer-app`](../apps/assisted-installer-app/), a micro-frontend served by
[uhc-portal](https://github.com/RedHatInsights/uhc-portal), the application behind
[console.redhat.com/openshift](https://console.redhat.com/openshift).

See the [`assisted-installer-app` README](../apps/assisted-installer-app/README.md) for development
workflows.
