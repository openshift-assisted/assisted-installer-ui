...
import ClusterPropertiesList from '@openshift-assisted/common/components/clusterDetail/ClusterPropertiesList';
...
import { EventsModal } from '@openshift-assisted/common/components/ui/eventsModal';
