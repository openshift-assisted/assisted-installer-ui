...
import { ValidationGroup as ClusterValidationGroup } from '@openshift-assisted/common';
import { ValidationGroup as HostValidationGroup } from '@openshift-assisted/common/types/hosts';
import {
  ClusterValidationId,
  HostValidationId,
