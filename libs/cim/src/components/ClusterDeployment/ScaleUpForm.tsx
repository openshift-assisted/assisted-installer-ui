...
import SwitchField from '@openshift-assisted/common/components/ui/formik/SwitchField';
...
import RadioField from '@openshift-assisted/common/components/ui/formik/RadioField';
