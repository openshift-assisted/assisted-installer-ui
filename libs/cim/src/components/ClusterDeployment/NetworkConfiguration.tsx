...
import AdvancedNetworkFields from '@openshift-assisted/common/components/clusterConfiguration/AdvancedNetworkFields';
import { NetworkConfigurationValues } from '@openshift-assisted/common/types/clusters';
import { Address6 } from 'ip-address';
import {
  VirtualIPControlGroup,
  VirtualIPControlGroupProps,
} from '@openshift-assisted/common/components/clusterWizard/networkingSteps/VirtualIPControlGroup';
import { AvailableSubnetsControl } from '@openshift-assisted/common/components/clusterWizard/networkingSteps/AvailableSubnetsControl';
import { ManagedNetworkingControlGroup } from '@openshift-assisted/common/components/clusterWizard/networkingSteps/ManagedNetworkingControlGroup';
import { UserManagedNetworkingTextContent } from '@openshift-assisted/common/components/clusterWizard/networkingSteps/UserManagedNetworkingTextContent';
import {
...
import { NetworkTypeControlGroup } from '@openshift-assisted/common/components/clusterWizard/networkingSteps/NetworkTypeControlGroup';
