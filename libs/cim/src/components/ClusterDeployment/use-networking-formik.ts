...
import { getHostSubnets } from '@openshift-assisted/common/components/clusterConfiguration/utils';
...
import useDeepCompareMemoize from '@openshift-assisted/common/hooks/useDeepCompareMemoize';
import {
  HostSubnets,
