...
import { MultiSelectField, PopoverIcon } from '@openshift-assisted/common';
import { AGENT_LOCATION_LABEL_KEY, AGENT_NOLOCATION_VALUE } from '../common';
import { AgentK8sResource } from '../../types';
import { MultiSelectOption } from '@openshift-assisted/common/components/ui/formik/types';
      ...
      bodyContent={
        <>
          ...
          <Trans
            t={t}
            components={{ bold: <strong /> }}
            i18nKey="ai:Set <bold>{{agent_location_label_key}}</bold> label in Agent resource to specify its location."
