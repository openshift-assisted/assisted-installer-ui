...
import ClusterProgress from '@openshift-assisted/common/components/clusterDetail/ClusterProgress';
import ClusterProgressItems from '@openshift-assisted/common/components/clusterDetail/ClusterProgressItems';
import { AgentK8sResource } from '../../types/k8s/agent';
import { AgentClusterInstallK8sResource } from '../../types/k8s/agent-cluster-install';
import { ClusterDeploymentK8sResource } from '../../types/k8s/cluster-deployment';
import { EventListFetchProps } from '@openshift-assisted/common';
