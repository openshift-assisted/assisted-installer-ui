...
import { TableRow } from '@openshift-assisted/common/components/hosts/AITable';
import { getHostRowHardwareInfo } from '@openshift-assisted/common/components/hosts/hardwareInfo';
...
import { fileSize } from '@openshift-assisted/common/utils';
