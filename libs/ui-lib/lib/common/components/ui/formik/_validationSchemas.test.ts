...
describe('validationSchemas', () => {
  ...
  describe('dualStackValidationSchema', () => {
    describe('OCP < 4.12 (legacy behavior)', () => {
      ...
      test('rejects IPv4 as secondary for OCP < 4.12', async () => {
        const invalidValues = [[{ cidr: '192.168.1.0/24' }, { cidr: '10.0.0.0/24' }]];
    ...
    describe('OCP >= 4.12 (new behavior)', () => {
      ...
      test('rejects IPv6 as primary and IPv6 as secondary (not dual-stack)', async () => {
        const invalidValues = [[{ cidr: '2001:db8::/64' }, { cidr: '2001:db9::/64' }]];
      ...
      test('rejects IPv4 as primary and IPv4 as secondary (not dual-stack)', async () => {
        const invalidValues = [[{ cidr: '192.168.1.0/24' }, { cidr: '10.0.0.0/24' }]];
