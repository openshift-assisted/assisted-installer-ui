...
import NewFeatureSupportLevelBadge from '@openshift-assisted/common/components/newFeatureSupportLevels/NewFeatureSupportLevelBadge';
import { getFieldId, OperatorsValues, PopoverIcon } from '@openshift-assisted/common';
...
import {
  ...
  OperatorSpec,
  useOperatorSpecs,
} from '@openshift-assisted/common/components/operators/operatorSpecs';
