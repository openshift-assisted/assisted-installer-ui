...
import { NewFeatureSupportLevelMap } from '@openshift-assisted/common/components/newFeatureSupportLevels/types';
...
import OcmTNADisclaimer from '@openshift-assisted/common/components/clusterConfiguration/OcmTNADisclaimer';
...
const ControlPlaneNodesDropdown: React.FC<ControlPlaneNodesDropdownProps> = ({
  ...
  const toggle = (toggleRef: React.Ref<MenuToggleElement>) => (
    <MenuToggle
      ...
      data-testid="control-plane-nodes-dropdown-toggle"
    >
