...
import { getFormikArrayItemFieldName, LoadingState } from '@openshift-assisted/common';
import ConfirmationModal from '@openshift-assisted/common/components/ui/ConfirmationModal';
...
export const RemoveItemButton: React.FC<{
  ...
  <Button
    icon={<MinusCircleIcon onClick={onRemove} data-testid={dataTestId} />}
