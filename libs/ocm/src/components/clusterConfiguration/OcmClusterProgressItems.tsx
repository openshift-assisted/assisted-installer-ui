...
import { FinalizingProgress } from '@openshift-assisted/common/components/clusterDetail/FinalizingProgress';
import { ProgressBarTexts } from '@openshift-assisted/common/components/clusterDetail/ProgressBarTexts';
