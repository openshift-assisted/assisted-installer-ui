...
import { ValidationsInfo as ClusterValidationsInfo } from '@openshift-assisted/common/types/clusters';
import { ValidationsInfo as HostValidationsInfo } from '@openshift-assisted/common/types/hosts';
