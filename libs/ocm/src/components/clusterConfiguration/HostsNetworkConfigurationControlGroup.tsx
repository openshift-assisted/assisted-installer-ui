...
import { getFieldId } from '@openshift-assisted/common/components/ui/formik/utils';
import { HostsNetworkConfigurationType } from '../../services/types';
import { useField } from 'formik';
import { useClusterWizardContext } from '../clusterWizard/ClusterWizardContext';
import RadioFieldWithTooltip from '@openshift-assisted/common/components/ui/formik/RadioFieldWithTooltip';
import {
  clusterExistsReason,
