...
} from '@openshift-assisted/common/types/featureSupportLevel';
import { TECH_SUPPORT_LEVEL_LINK } from '@openshift-assisted/common/config/docs_links';
import ExternalLink from '@openshift-assisted/common/components/ui/ExternalLink';
import { Cluster } from '@openshift-assisted/types/assisted-installer-service';
import { DetailItem, UiIcon } from '@openshift-assisted/common';
import { getLimitedFeatureSupportLevels } from '@openshift-assisted/common/components/newFeatureSupportLevels/utils';
...
import { NewFeatureSupportLevelData } from '@openshift-assisted/common/components/newFeatureSupportLevels/types';
