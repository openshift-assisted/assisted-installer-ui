...
import {
  ...
  RadioFieldProps,
  SwitchFieldProps,
} from '@openshift-assisted/common/components/ui/formik/types';
import { RichInputFieldPropsProps } from '@openshift-assisted/common/components/ui/formik/RichInputField';
