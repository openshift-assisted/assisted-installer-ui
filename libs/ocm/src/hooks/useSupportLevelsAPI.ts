...
import { CpuArchitecture, SupportedCpuArchitecture, useAlerts } from '@openshift-assisted/common';
import {
...
import NewFeatureSupportLevelsAPI from '@openshift-assisted/common/api/assisted-service/NewFeatureSupportLevelsAPI';
