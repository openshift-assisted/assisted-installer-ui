...
import type { AssistedInstallerPermissionTypesListType } from '@openshift-assisted/common/features/featureGate';
import {
  handleApiError,
  getApiErrorMessage,
  getApiErrorCode,
...
import { ResourceUIState } from '@openshift-assisted/common/types/resource-ui-state';
