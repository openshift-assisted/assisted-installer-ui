...
### Off-limits directories — do NOT touch
**Never modify any file under these directories:**
- `apps/assisted-chatbot/` — chatbot app (separate team, unrelated to installer flows)
- `libs/chatbot/` — chatbot library

If the issue description mentions the chatbot, note it in `.ai-bot/pr.md` and stop — do not attempt a fix.
