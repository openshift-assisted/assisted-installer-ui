...
): AxiosPromise<Cluster> => client.post(`${API_ROOT}/clusters`, params);

export const patchCluster = (
	id: string,
	params: ClusterUpdateParams
): AxiosPromise<Cluster> => client.patch(`${API_ROOT}/clusters/${id}`, params);
...
export const enableClusterHost = (
	clusterId: string,
	hostId: string
): AxiosPromise<void> =>
	client.post(
		`${API_ROOT}/clusters/${clusterId}/hosts/${hostId}/actions/enable`
	);

export const disableClusterHost = (
	clusterId: string,
	hostId: string
): AxiosPromise<void> =>
	client.delete(
...
export const getClusterDownloadsImageUrl = (
	clusterId: string,
	imageId: string
