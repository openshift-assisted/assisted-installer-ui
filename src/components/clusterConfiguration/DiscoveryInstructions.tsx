...
const DiscoveryInstructions = ({ isMultiNodeCluster = false }: { isMultiNodeCluster: boolean }) => (
  <>
    ...
    <Text component="p">
      ...
      booting (PXE) to <b>boot once</b> your {`${isMultiNodeCluster ? 'machines' : 'machine'}`} from
      it on hardware that should become part of this OCP cluster.
      <br />
