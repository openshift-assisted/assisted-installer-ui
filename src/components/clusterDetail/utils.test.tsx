import { getClusterMemoryAmount, getClustervCPUCount } from './utils';
  ...
  hosts: [
    {
      ...
      inventory: '{"cpu":{"count":2},"memory":{"physical_bytes":9323937792}}',
      status: 'error',
      role: 'worker',
    },
    {
      id: '47b3897e-795f-4a3c-a4a2-11876a1fa610',
      inventory: '{"cpu":{"count":4},"memory":{"physical_bytes":17809014784}}',
      status: 'error',
      role: 'master',
    },
    {
...
describe('clusterDetail/utils', () => {
  ...
  describe('getClustervCPUCount', () => {
    it('returns the total number of vCPUs', () => {
      const actual = getClustervCPUCount(cluster);
      expect(actual).toBeCloseTo(16, 0);
    });
  });
});
