...
export const discoveryTroubleshootingModalContent = (
  <TextContent>
    ...
    <Text component={TextVariants.p}>
      Note: Boot time depends on several factors such as your hardware and network configuration,
      and if you are booting from an ISO.
    </Text>
    <Text component={TextVariants.h2}>Verify if DHCP is enabled</Text>
    <Text component={TextVariants.h2}>SSH into your machine</Text>
    <Text component={TextVariants.p}>
      Verify that you can access your host machine using SSH, or a console such as BMC or virtual
      machine console. In the CLI, enter the following command:
    </Text>
